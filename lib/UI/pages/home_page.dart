import 'package:auth/UI/pages/choose_page.dart';
import 'package:auth/utils/background.clippath.util.dart';
import 'package:auth/utils/cube.painter.util.dart';
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      'A one-stop App for you to connect with the Social Applications.',
                      style: TextStyle(
                        fontSize: 15,
                        color: Colors.grey,
                        height: 2,
